    ...
    <div className="stats text-white">
      ...
      <div className="flex items-center justify-between gap-10 mx-24 py-24 ">
        ...
        <div>
          ...
          <button className="button mx-auto border-slate-500 content-end bg-[#9FF119] flex items-center  bg-[#0e0f0ec8] hover:bg-[#ffffff] w-fit text-[#000000] hover:text-black text-[14.5px] py-2 px-4 rounded-md font-[500]">
            Learn More
          </button>
        </div>
      </div>
